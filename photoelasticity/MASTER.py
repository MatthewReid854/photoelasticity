...
if __name__ == '__main__':
    ...
    ## STEP 2. Image transformation. If image alignment is required, uncomment this section.
    ## Alignment points need to be entered manually after getting the alignment points using the below two lines
    ...
    ## Bounding box dimensions. Do not comment out this section. It is needed in subsequent steps.
    bbox_column_start = 2
    bbox_row_start = 160
    width = 600
    height = 140
    ...
    ## STEP 5. Plotting.
    contour_plots(directory_name=directory_name, strained_image_name=strained_image_name, bounding_box=bbox, gaussian_sigma=3, mask_edges=True, hide_colorbar=True, log_scale=False, only_plot_amplitude=False, show_plot=True, cmap='viridis')
    ...
    ## To plot multiple contour plots together, you can pass the ax to contour_plots. The below example changes gaussian_sigma from 0 to 5
